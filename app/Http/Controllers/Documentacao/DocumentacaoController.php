...
class DocumentacaoController extends Controller
{
    ...
    public function index()
    {
        ...
        $status = array(
            ...
            Constants::$ETAPA_WORKFLOW_QUALIDADE_TEXT_SHORT => Constants::$ETAPA_WORKFLOW_QUALIDADE_TEXT_SHORT,
            Constants::$ETAPA_WORKFLOW_UPLOAD_LISTA_DE_PRESENCA_TEXT_SHORT => Constants::$ETAPA_WORKFLOW_UPLOAD_LISTA_DE_PRESENCA_TEXT_SHORT
        );
