                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => 'fornecedores.salvar', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 margin-top-1percent">
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn waves-effect waves-light btn-block btn-lg btn-secondary" >CRIAR FORNECEDOR</button>
                                                </div>
                                            </div>
                                        </div>     
                                    </div>
