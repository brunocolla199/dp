            ...
            <div class="row page-titles">
                <div class="col-md-5 col-8 align-self-center">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Criar Opção</li>
                    </ol>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {!! Form::open(['route' => 'controle-registros.store-option', 'class' => 'form-horizontal']) !!}
                                ...
                                <div class="row m-t-20">
                                    ...
                                    <div class="col-md-4">
                                        <button type="submit" class="btn btn-block btn-success waves-effect waves-light">Criar</button>
                                    </div>
                                </div>
                            {!! Form::close() !!}
