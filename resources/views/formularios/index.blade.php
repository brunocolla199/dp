                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group required">
                                                            ...
                                                            <div class="col-md-12">
                                                                {!! Form::select('setor_dono_form', $sectorsAccess, key($setorUsuarioAtual), ['class' => 'form-control  custom-select', 'required' => 'required']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                            ...
                                                            @if( is_array($formularios) && array_key_exists("finalizados", $formularios) && count($formularios['finalizados']) > 0 )
                                                                @foreach($formularios['finalizados'] as $form)
                                                                    ...
                                                                    @if( $form->obsoleto && Auth::user()->setor_id == Constants::$ID_SETOR_QUALIDADE )
                                                                        <tr>
                                                                            <td class="text-nowrap text-center"> 
                                                                                <a href="javascript:void(0)" class="btn-ativar-formulario-modal ml-3" data-id="{{ $form->id }}"> <i class="fa fa-power-off text-success" data-toggle="tooltip" data-original-title="Ativar Formulário"></i> </a> 
                                                                            </td>
